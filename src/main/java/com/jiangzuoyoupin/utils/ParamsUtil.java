...
/**
 * 参数校验工具类
 * Created by xutiantian on 17/3/21.
 */
public class ParamsUtil {
    ...
    public static void checkMobileNo(String mobileNo) {
        if (!CheckUtils.checkMobileNo(mobileNo)) {
            throw new BizException(ErrorEnum.ERROR_PARAM_MOBILE);
        }
    }
